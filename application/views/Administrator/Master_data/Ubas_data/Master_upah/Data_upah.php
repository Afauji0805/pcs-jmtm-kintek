<main class="container">
    <div class="d-flex align-items-center p-3 my-2 text-dark rounded shadow-lg" style="background: #ADA996;  /* fallback for old browsers */
            ...
            ">
        <i class="fa-solid fa-money-bill-wave fa-bounce fa-2xl"></i>&nbsp;&nbsp;
        <div class="lh-1">
            <h1 class="h6 mb-0 text-dark lh-1"><b>Master Data Upah</b></h1>
        ...
        <div class="pt-3">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                        ...
                        <tr>
                            <td scope="col" class="text-start text-muted">
                                <small>
                                    ...
                                    Tabel Master Data Upah
                                </small>
                            </td>
                            <td scope="col align-baseline" class="text-end">
                                <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop-tambah-upah">
                    ...
                    <table class="table-bordered table-sm table-hover align-middle border-dark example" style="width:100%">
    ...
    <!-- Modal Tambah Upah -->
    <div class="modal fade" id="staticBackdrop-tambah-upah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="d-flex align-items-center p-2 my-2 text-white rounded shadow-lg" style="background: #36D1DC;  /* fallback for old browsers */
                        ...
                        <div class="lh-1">
                            <h1 class="h6 mb-0 text-white lh-1">
                                <b>Tambah Master Data Upah</b>
                            </h1>
                            <small>
                                Halaman Pop Up Ini Berfungsi Untuk Menambah Master Data Upah
                            </small>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col-12 col-sm-12">
                                        <form id="form-tambah-upah" class="row g-1" method="post" action="<?= site_url('Administrator/Master_data/Master_upah/Master_data_upah/tambah') ?>">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control form-control-sm" id="kode_upah" name="kode_upah" value="<?= isset($kode_otomatis) ? $kode_otomatis : '' ?>" disabled>
                                                        <label>
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control form-control-sm" id="uraian_upah" name="uraian_upah" placeholder="Uraian Upah">
                                                        <label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control form-control-sm" id="satuan_upah" name="satuan_upah">
                                                        <label>
    ...
    <!-- End Modal Tambah Upah -->

    <!-- Modal Detail Master Data Upah -->
    <div class="modal fade" id="staticBackdrop-detail-upah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="d-flex align-items-center p-2 my-2 text-white rounded shadow-lg" style="background: #36D1DC;  /* fallback for old browsers */
                        ...
                        <div class="lh-1">
                            <h1 class="h6 mb-0 text-white lh-1">
                                <b>Detail Master Data Upah</b>
                            </h1>
                            <small>
                                Halaman Pop Up Ini Berfungsi Untuk Detail Master Data Upah
                            </small>
                        </div>
                    </div>
                    <div class="my-2 p-2 bg-body rounded shadow-lg">
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <table class="table table-sm table-striped" id="detail-table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted" colspan="4" id="status-upah">
                                                    <div class="d-flex justify-content-start">
                                        ...
                                        <h6 class="border-bottom border-dark pb-2 mb-0">
                                            <i class="fa-solid fa-circle-info px-1"></i>
                                            Detail Tabel Data Upah Per Supplier
                                        </h6><br>
    ...
    <!-- End Modal Detail Master Data Upah -->

    <!-- Modal Ubah Upah -->
    <div class="modal fade" id="staticBackdrop-ubah-upah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="d-flex align-items-center p-2 my-2 text-white rounded shadow-lg" style="background: #36D1DC;  /* fallback for old browsers */
                        ...
                        <div class="lh-1">
                            <h1 class="h6 mb-0 text-white lh-1">
                                <b>Ubah Master Data Upah</b>
                            </h1>
                            <small>
                                Halaman Pop Up Ini Berfungsi Untuk Mengubah Master Data Upah
                            </small>
                        </div>
                    </div>
                    <div class="my-2 p-2 bg-body rounded shadow-lg">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center" style="background: #232526;  /* fallback for old browsers */
                                ...
                                <div class="flex-grow-1 bd-highlight">
                                    <span class="text-white">
                                        <i class="fa-solid fa-address-card fa-lg px-1"></i>
                                        <small>
                                            Form Ubah Master Data Upah
                                        </small>
                                    </span>
                                </div>
                            </div>
                            <div class="card-body">
                                <input type="hidden" id="id_ubah_upah">
                                <div class="row align-items-start">
                                    <div class="col-12 col-sm-12">
                                        <form class="row g-1" id="form-ubah-upah">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control form-control-sm" id="kode_ubah_upah" placeholder="Kode" disabled>
                                                        <label>
                                                            <i class="fa-solid fa-barcode fa-sm"></i>&nbsp;
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control form-control-sm" id="uraian_ubah_upah" placeholder="Uraian Item">
                                                        <label>
                                                            <i class="fa-solid fa-person-digging fa-sm"></i>&nbsp;
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control form-control-sm" id="satuan_ubah_upah" placeholder="Satuan Item">
                                                        <label>
                                                            <i class="fa-solid fa-recycle fa-sm"></i>&nbsp;
                                                            <small>Satuan Item</small>
                                                        </label>
    ...
    <!-- Modal Tambah Detil Upah Per-Supplier -->
    <div class="modal fade" id="staticBackdrop-tambah-detail-upah-supplier" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="d-flex align-items-center p-2 my-2 text-white rounded shadow-lg" style="background: #36D1DC;  /* fallback for old browsers */
                        ...
                        <div class="lh-1">
                            <h1 class="h6 mb-0 text-white lh-1">
                                <b>Tambah Detail Data Item Upah Per-Supplier</b>
                            </h1>
                            <small>
                                Halaman Pop Up Ini Berfungsi Untuk Tambah Detail Data Item Upah Per-Supplier
                            </small>
                        </div>
                    </div>
                    <div class="my-2 p-2 bg-body rounded shadow-lg">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center" style="background: #232526;  /* fallback for old browsers */
                                ...
                                <div class="flex-grow-1 bd-highlight">
                                    <span class="text-white">
                                        <i class="fa-solid fa-address-card fa-lg px-1"></i>
                                        <small>
                                            Form Tambah Detail Data Item Upah Per-Supplier
                                        </small>
                                    </span>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 col-sm-12">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <table class="table table-sm table-striped" id="detail-table">
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">
                                                            <div class="d-flex justify-content-start">
                                                                <small id="kode-upah-suplier"></small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content-start">
                                                        ...
                                                        <td class="text-muted">
                                                            <div class="d-flex justify-content-start">
                                                                <small id="uraian-upah-suplier"></small>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">
                                                            <div class="d-flex justify-content-start">
                                                                <small id="satuan-upah-suplier"></small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content-start">
                                                        ...
                                                        <td class="text-muted" colspan="4" id="status-upah-suplier">
                                                            <div class="d-flex justify-content-start">
                                                                <span class="badge text-bg-success">
                                                                    <i class="fa-solid fa-recycle fa-lg"></i>
                                                                    &nbsp;
                                        ...
                                        <div class="card shadow-lg border-dark">
                                            <div class="card-body">
                                                <h6 class="border-bottom border-dark pb-2 mb-0">
                                                    <i class="fa-solid fa-circle-info px-1"></i>
                                                    Form Detail Data Upah Per Supplier
                                                </h6><br>
                                                <form class="row g-1" id="form_tambah_detail_supplier">
                                                    <input type="hidden" id="hidden_kode_upah" value="">
                                                    <input type="hidden" id="hidden_id_upah" value="">
                                                    <input type="hidden">
                                                    <div class="col-md-1">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control form-control-sm" list="datalistOptions_supplier" id="search_supplier_upah" placeholder="Ketik kode supplier...">
                                                ...
                                                <table class="table table-sm align-middle">
                                                    <tr>
                                                        <td scope="col" class="text-start text-muted">
                                                            <small>
                                                                <i class="fa-solid fa-table fa-lg px-1"></i>
                                                                Tabel Detail Data Item Upah Per-Supplier
                                                            </small>
                                                        </td>
                                                    </tr>
                                                </table>
    ...
    </div><!-- End Modal Tambah Detil Upah Per-Supplier -->
</main>