<main class="container">
    <div class="d-flex align-items-center p-3 my-2 text-dark rounded shadow-lg" style="background: #ADA996;  /* fallback for old browsers */
            ...
            ">
        <i class="fa-solid fa-paste fa-bounce fa-2xl"></i>&nbsp;&nbsp;
        <div class="lh-1">
            <h1 class="h6 mb-0 text-dark lh-1"><b>Data DKH Rencana Kontrak</b></h1>
                        ...
                        <div class="col-12 col-sm-12">
                            ...
                            <div class="card shadow-lg border-dark">
                                <div class="card-body">
                                    ...
                                    <h6 class="border-bottom border-white pb-2 mb-0"></h6>
                                    <div class="flex-grow-1 bd-highlight">
                                        <button id="addRow" class="btn btn-secondary btn-sm rounded shadow-lg">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center"
                                ...
                                <div class="flex-grow-1 bd-highlight">
                                    <span class="text-dark">
                                        ...
                                        <small>
                                            <strong>Form Data-data UBAS Pada Setiap Sub Divisi</strong>
                                        </small>
                                    </span>
                                </div>
                            </div>
                                        ...
                                        <div class="card shadow-lg border-dark">
                                            <div class="card-body">
                                                <h6 class="border-bottom border-dark pb-2 mb-0">
                                                    ...
                                                    <i class="fa-solid fa-circle-info px-1"></i>
                                                    Informasi Data Pada Setiap Divisi & Sub Divisi
                                                </h6>
